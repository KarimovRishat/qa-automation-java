 ...
 */
public class ProcessingMessageService extends ValidatedService implements MessageService {
     ...
     *
     */
    public ProcessingMessageService(Printer printer, MessageDecorator decorator) {
